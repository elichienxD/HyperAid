...
function metric_to_structure(d;rng_seed=0,tol = 1e-8,increase = false, check_cluster = false)
    
    #Set Random seed here, by default we use seed 0.
...
function recursive_step(G,W,V,x,y,z,ztype;tol = 1e-5,increase = false, check_cluster = false)
    ...
    G,W = zone1_recurse(G,W,R1,r,tol = tol, check_cluster = check_cluster)
    G,W = zone1_recurse(G,W,X1,x,tol = tol, check_cluster = check_cluster)
    G,W = zone1_recurse(G,W,Y1,y,tol = tol, check_cluster = check_cluster)
    G,W = zone1_recurse(G,W,Z1,z,tol = tol, check_cluster = check_cluster)
    
    G,W = zone2_recurse(G,W,X2,x,r,tol = tol, check_cluster = check_cluster)
    G,W = zone2_recurse(G,W,Y2,y,r,tol = tol, check_cluster = check_cluster)
    G,W = zone2_recurse(G,W,Z2,z,r,tol = tol, check_cluster = check_cluster)
...
function zone1_recurse(G,W,V, x; tol = 1e-5, increase = false, check_cluster = false)
    ...
    for i = 2:16
        ...
        G,W = zone1_recurse(G,W,R1p,r,tol = tol,increase = increase, check_cluster = check_cluster)
    end
    ...
    G,W = zone1_recurse(G,W,X1p,x,tol = tol,increase = increase, check_cluster = check_cluster)
    G,W = zone1_recurse(G,W,Y1p,y,tol = tol,increase = increase, check_cluster = check_cluster)
    G,W = zone1_recurse(G,W,Z1p,z,tol = tol,increase = increase, check_cluster = check_cluster)
    
    G,W = zone2_recurse(G,W,X2p,x,r,tol = tol,increase = increase, check_cluster = check_cluster)
    G,W = zone2_recurse(G,W,Y2p,y,r,tol = tol,increase = increase, check_cluster = check_cluster)
    G,W = zone2_recurse(G,W,Z2p,z,r,tol = tol,increase = increase, check_cluster = check_cluster)
